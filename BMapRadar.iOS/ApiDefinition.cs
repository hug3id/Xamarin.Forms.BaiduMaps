...
namespace BMapRadar
{
	...
	interface BMKRadarManager
	{
		...
		//[Verify(MethodToProperty)]
		BMKRadarManager RadarManagerInstance { get; }
		...
		void AddRadarManagerDelegate(BMKRadarManagerDelegate @delegate);

		// -(void)removeRadarManagerDelegate:(id<BMKRadarManagerDelegate>)delegate;
		[Export("removeRadarManagerDelegate:")]
		void RemoveRadarManagerDelegate(BMKRadarManagerDelegate @delegate);
