...
namespace BMapSearch
{
	...
	interface BMKPoiResult
	{
		...
		NSObject[] PoiInfoList { get; set; }

		// @property (nonatomic, strong) NSArray * cityList;
		[Export("cityList", ArgumentSemantic.Strong)]
		//[Verify(StronglyTypedNSArray)]
		NSObject[] CityList { get; set; }
	...
	interface BMKPoiIndoorResult
	{
		...
		//[Verify(StronglyTypedNSArray)]
		NSObject[] PoiIndoorInfoList { get; set; }
	}
	...
	interface BMKRouteStep
	{
		...
		//unsafe BMKMapPoint* Points { get; set; }
