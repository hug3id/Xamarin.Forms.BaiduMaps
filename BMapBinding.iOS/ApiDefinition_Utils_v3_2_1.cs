...
namespace BMapBinding
{
    ...
    {
        // +(id)openBaiduMapNavigation:(BMKNaviPara *)para;
        [Static]
        [Export("openBaiduMapNavigation:")]
        NSObject OpenBaiduMapNavigation(BMKNaviPara para);

        // +(id)openBaiduMapWalkNavigation:(BMKNaviPara *)para;
        [Static]
        [Export("openBaiduMapWalkNavigation:")]
        NSObject OpenBaiduMapWalkNavigation(BMKNaviPara para);

        // +(id)openBaiduMapRideNavigation:(BMKNaviPara *)para;
        [Static]
        [Export("openBaiduMapRideNavigation:")]
        NSObject OpenBaiduMapRideNavigation(BMKNaviPara para);
    }
